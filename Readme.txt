...
Запускать BatchUnpack.bat рядом с InnoSetup файлами. 
В utils: 
1.innounp.exe(можно обновить с https://www.rathlev-home.de/tools/download/innounp-2.zip), консольный распаковчик
...
In utils:
1.innounp.exe(can be updated from https://www.rathlev-home.de/tools/download/innounp-2.zip), console unpacker
