# Use BatchInnoUnpack
<br>Run on Windows 7 and later. IFPSdasm require NET Framework 4.7.2 and +. PowerShell is required for autoinstall components or download the latest complete archiv.
